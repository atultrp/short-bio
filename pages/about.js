...
const about = () => {
  ...
  const quoteByMe = [{ quote: "While it's true that someone else's actions can either negatively or positively impact your life, ultimately, it's up to you to determine the direction in which you want to go. It's important to choose the path that aligns with your personal goals and values because this is your life, and you owe it to yourself to strive for excellence." }, { quote: "If you come across someone who genuinely cares about you, it's important not to let them go because they are the ones who truly desire to bring you authentic happiness." }, { quote: "It's essential to keep in mind that the perfect timing for taking action towards your personal goals will never come, as the best time to act is always the present. Therefore, make the most of the present moment and strive to do your very best to accomplish your objectives." }]

  return (
    <>
      <Head>
        <title>Short Bio - About Us</title>
