...
const Card = ({ data, customClasses }) => {
  ...
  return (
    <div className={`${customClasses} px-4 py-4 md:px-6 lg:px-12 md:py-6 my-2 min-w-full md:min-w-0 md:w-1/2 2xl:w-1/3 flex flex-col items-start rounded-2xl hover:shadow-[-10px_-10px_30px_4px_rgba(139,92,246,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] ease-in-out transition-shadow`}>
      <div className=''>
        ...
        <div className='mt-3'>
          <p className="leading-relaxed mb-8 line-clamp-4 text-sm md:text-base">{data?.bio}</p>
